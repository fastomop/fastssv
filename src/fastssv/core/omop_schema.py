...
OMOP_SCHEMA: Dict[str, List[ColumnDef]] = {
    ...
    "person": [
        ColumnDef("person_id", "integer", nullable=False, primary_key=True),
        ColumnDef("gender_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("year_of_birth", "integer", nullable=False),
        ColumnDef("month_of_birth", "integer"),
        ColumnDef("day_of_birth", "integer"),
        ColumnDef("birth_datetime", "datetime"),
        ColumnDef("race_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("ethnicity_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "observation_period": [
        ColumnDef("observation_period_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("observation_period_start_date", "date", nullable=False),
        ColumnDef("observation_period_end_date", "date", nullable=False),
        ColumnDef("period_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "visit_occurrence": [
        ColumnDef("visit_occurrence_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("visit_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("visit_start_date", "date", nullable=False),
        ColumnDef("visit_start_datetime", "datetime"),
        ColumnDef("visit_end_date", "date", nullable=False),
        ColumnDef("visit_end_datetime", "datetime"),
        ColumnDef("visit_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("provider_id", "integer", foreign_key=True, foreign_table="provider", foreign_column="provider_id"),
        ColumnDef("care_site_id", "integer", foreign_key=True, foreign_table="care_site", foreign_column="care_site_id"),
    ...
    "condition_occurrence": [
        ColumnDef("condition_occurrence_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("condition_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("condition_start_date", "date", nullable=False),
        ColumnDef("condition_start_datetime", "datetime"),
        ColumnDef("condition_end_date", "date"),
        ColumnDef("condition_end_datetime", "datetime"),
        ColumnDef("condition_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "drug_exposure": [
        ColumnDef("drug_exposure_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("drug_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("drug_exposure_start_date", "date", nullable=False),
        ColumnDef("drug_exposure_start_datetime", "datetime"),
        ColumnDef("drug_exposure_end_date", "date", nullable=False),
        ColumnDef("drug_exposure_end_datetime", "datetime"),
        ColumnDef("verbatim_end_date", "date"),
        ColumnDef("drug_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("stop_reason", "varchar"),
    ...
    "procedure_occurrence": [
        ColumnDef("procedure_occurrence_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("procedure_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("procedure_date", "date", nullable=False),
        ColumnDef("procedure_datetime", "datetime"),
        ColumnDef("procedure_end_date", "date"),
        ColumnDef("procedure_end_datetime", "datetime"),
        ColumnDef("procedure_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "measurement": [
        ColumnDef("measurement_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("measurement_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("measurement_date", "date", nullable=False),
        ColumnDef("measurement_datetime", "datetime"),
        ColumnDef("measurement_time", "varchar"),
        ColumnDef("measurement_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "observation": [
        ColumnDef("observation_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("observation_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("observation_date", "date", nullable=False),
        ColumnDef("observation_datetime", "datetime"),
        ColumnDef("observation_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("value_as_number", "numeric"),
    ...
    "death": [
        ColumnDef("person_id", "integer", nullable=False, primary_key=True, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("death_date", "date", nullable=False),
    ...
    # Vocabulary Tables
    "concept": [
        ColumnDef("concept_id", "integer", nullable=False, primary_key=True),
        ColumnDef("concept_name", "varchar", nullable=False),
        ColumnDef("domain_id", "varchar", nullable=False, foreign_key=True, foreign_table="domain", foreign_column="domain_id"),
        ColumnDef("vocabulary_id", "varchar", nullable=False, foreign_key=True, foreign_table="vocabulary", foreign_column="vocabulary_id"),
        ColumnDef("concept_class_id", "varchar", nullable=False, foreign_key=True, foreign_table="concept_class", foreign_column="concept_class_id"),
        ColumnDef("standard_concept", "varchar"),
        ColumnDef("concept_code", "varchar", nullable=False),
        ColumnDef("valid_start_date", "date", nullable=False),
        ColumnDef("valid_end_date", "date", nullable=False),
        ColumnDef("invalid_reason", "varchar"),
    ],

    "vocabulary": [
        ColumnDef("vocabulary_id", "varchar", nullable=False, primary_key=True),
        ColumnDef("vocabulary_name", "varchar", nullable=False),
        ColumnDef("vocabulary_reference", "varchar"),
        ColumnDef("vocabulary_version", "varchar"),
        ColumnDef("vocabulary_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "domain": [
        ColumnDef("domain_id", "varchar", nullable=False, primary_key=True),
        ColumnDef("domain_name", "varchar", nullable=False),
        ColumnDef("domain_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "concept_class": [
        ColumnDef("concept_class_id", "varchar", nullable=False, primary_key=True),
        ColumnDef("concept_class_name", "varchar", nullable=False),
        ColumnDef("concept_class_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "concept_relationship": [
        ColumnDef("concept_id_1", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("concept_id_2", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("relationship_id", "varchar", nullable=False, foreign_key=True, foreign_table="relationship", foreign_column="relationship_id"),
        ColumnDef("valid_start_date", "date", nullable=False),
        ColumnDef("valid_end_date", "date", nullable=False),
        ColumnDef("invalid_reason", "varchar"),
    ],
    ...
    "relationship": [
        ColumnDef("relationship_id", "varchar", nullable=False, primary_key=True),
        ColumnDef("relationship_name", "varchar", nullable=False),
        ColumnDef("is_hierarchical", "varchar", nullable=False),
        ColumnDef("defines_ancestry", "varchar", nullable=False),
        ColumnDef("reverse_relationship_id", "varchar", nullable=False, foreign_key=True, foreign_table="relationship", foreign_column="relationship_id"),
        ColumnDef("relationship_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "concept_synonym": [
        ColumnDef("concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("concept_synonym_name", "varchar", nullable=False),
        ColumnDef("language_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "concept_ancestor": [
        ColumnDef("ancestor_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("descendant_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("min_levels_of_separation", "integer", nullable=False),
        ColumnDef("max_levels_of_separation", "integer", nullable=False),
    ],

    "source_to_concept_map": [
        ColumnDef("source_code", "varchar", nullable=False),
        ColumnDef("source_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("source_vocabulary_id", "varchar", nullable=False, foreign_key=True, foreign_table="vocabulary", foreign_column="vocabulary_id"),
        ColumnDef("source_code_description", "varchar"),
        ColumnDef("target_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("target_vocabulary_id", "varchar", nullable=False, foreign_key=True, foreign_table="vocabulary", foreign_column="vocabulary_id"),
        ColumnDef("valid_start_date", "date", nullable=False),
        ColumnDef("valid_end_date", "date", nullable=False),
        ColumnDef("invalid_reason", "varchar"),
    ],
    ...
    "drug_strength": [
        ColumnDef("drug_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("ingredient_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "location": [
        ColumnDef("location_id", "integer", nullable=False, primary_key=True),
    ...
    "care_site": [
        ColumnDef("care_site_id", "integer", nullable=False, primary_key=True),
    ...
    "provider": [
        ColumnDef("provider_id", "integer", nullable=False, primary_key=True),
    ...
    "condition_era": [
        ColumnDef("condition_era_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("condition_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("condition_era_start_date", "date", nullable=False),
        ColumnDef("condition_era_end_date", "date", nullable=False),
        ColumnDef("condition_occurrence_count", "integer"),
    ],

    "drug_era": [
        ColumnDef("drug_era_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("drug_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("drug_era_start_date", "date", nullable=False),
        ColumnDef("drug_era_end_date", "date", nullable=False),
        ColumnDef("drug_exposure_count", "integer"),
        ColumnDef("gap_days", "integer"),
    ],

    "dose_era": [
        ColumnDef("dose_era_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("drug_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("unit_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("dose_value", "numeric", nullable=False),
        ColumnDef("dose_era_start_date", "date", nullable=False),
        ColumnDef("dose_era_end_date", "date", nullable=False),
    ],

    "visit_detail": [
        ColumnDef("visit_detail_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("visit_detail_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("visit_detail_start_date", "date", nullable=False),
        ColumnDef("visit_detail_start_datetime", "datetime"),
        ColumnDef("visit_detail_end_date", "date", nullable=False),
        ColumnDef("visit_detail_end_datetime", "datetime"),
        ColumnDef("visit_detail_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("provider_id", "integer", foreign_key=True, foreign_table="provider", foreign_column="provider_id"),
        ColumnDef("care_site_id", "integer", foreign_key=True, foreign_table="care_site", foreign_column="care_site_id"),
        ...
        ColumnDef("visit_occurrence_id", "integer", nullable=False, foreign_key=True, foreign_table="visit_occurrence", foreign_column="visit_occurrence_id"),
    ],

    "device_exposure": [
        ColumnDef("device_exposure_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("device_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("device_exposure_start_date", "date", nullable=False),
        ...
        ColumnDef("device_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "specimen": [
        ColumnDef("specimen_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("specimen_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("specimen_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("specimen_date", "date", nullable=False),
    ...
    "note": [
        ColumnDef("note_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("note_date", "date", nullable=False),
        ColumnDef("note_datetime", "datetime"),
        ColumnDef("note_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("note_class_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("note_title", "varchar"),
        ColumnDef("note_text", "text", nullable=False),
        ColumnDef("encoding_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("language_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("provider_id", "integer", foreign_key=True, foreign_table="provider", foreign_column="provider_id"),
        ColumnDef("visit_occurrence_id", "integer", foreign_key=True, foreign_table="visit_occurrence", foreign_column="visit_occurrence_id"),
        ColumnDef("visit_detail_id", "integer", foreign_key=True, foreign_table="visit_detail", foreign_column="visit_detail_id"),
    ...
    "note_nlp": [
        ColumnDef("note_nlp_id", "integer", nullable=False, primary_key=True),
        ColumnDef("note_id", "integer", nullable=False, foreign_key=True, foreign_table="note", foreign_column="note_id"),
        ...
        ColumnDef("lexical_variant", "varchar", nullable=False),
        ...
        ColumnDef("nlp_date", "date", nullable=False),
    ...
    "episode": [
        ColumnDef("episode_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("episode_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("episode_start_date", "date", nullable=False),
        ...
        ColumnDef("episode_object_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("episode_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ...
    "episode_event": [
        ColumnDef("episode_id", "integer", nullable=False, foreign_key=True, foreign_table="episode", foreign_column="episode_id"),
        ColumnDef("event_id", "integer", nullable=False),
        ColumnDef("episode_event_field_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "fact_relationship": [
        ColumnDef("domain_concept_id_1", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("fact_id_1", "integer", nullable=False),
        ColumnDef("domain_concept_id_2", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
        ColumnDef("fact_id_2", "integer", nullable=False),
        ColumnDef("relationship_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
    ],

    "payer_plan_period": [
        ColumnDef("payer_plan_period_id", "integer", nullable=False, primary_key=True),
        ColumnDef("person_id", "integer", nullable=False, foreign_key=True, foreign_table="person", foreign_column="person_id"),
        ColumnDef("payer_plan_period_start_date", "date", nullable=False),
        ColumnDef("payer_plan_period_end_date", "date", nullable=False),
    ...
    # Health Economics
    "cost": [
        ColumnDef("cost_id", "integer", nullable=False, primary_key=True),
        ColumnDef("cost_event_id", "integer", nullable=False),
        ColumnDef("cost_domain_id", "varchar", nullable=False),
        ColumnDef("cost_type_concept_id", "integer", nullable=False, foreign_key=True, foreign_table="concept", foreign_column="concept_id"),
